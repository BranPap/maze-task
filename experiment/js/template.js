...
function init() {
  ...
  exp.structure=["i0",  "instructions", 'example', 'example2', 'almost', "trial", 'subj_info', 'thanks'];
  ...
  exp.gender = _.shuffle(['congruent_male','neutral_male','congruent_female','neutral_female']);

  exp.male_names = _.shuffle(["Michael","Jacob"])

  exp.female_names = _.shuffle(["Emily", "Hannah"])
